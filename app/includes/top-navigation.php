                    ...
                    <div class="container-fluid px-0">
                        ...
                        <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                            <ul class="navbar-nav navbar-nav-hover ms-auto">
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center <?= $page == "home" ? "text-primary" : "" ?>" 
                                    href="./?page=medicines/drug-interaction-checker">
                                        <i class="material-icons opacity-6 me-2 text-md">dashboard</i> Drug Interaction checking
                                    </a>
                                </li>

                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center <?= $page == "home" ? "text-primary" : "" ?>" 
                                    href="./?page=medicines/reminder">
                                        <i class="material-icons opacity-6 me-2 text-md">dashboard</i> Add Reminders
                                    </a>
                                </li>

                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center <?= $page == "home" ? "text-primary" : "" ?>" 
                                    href="./?page=medicines/list_reminder">
                                        <i class="material-icons opacity-6 me-2 text-md">dashboard</i> My Reminders
                                    </a>
                                </li>
